...
<br />
Final Rank Value:  1926.0<br />
<br />
Final Rank Value (1926.0) = Starting Rank Value (1954.5) + Head To Head Adjustments (-28.6)<br />

#### Starting Rank Value<br />
To figure out a rosters's Starting Rank Value, first take the average of these four factors:<br />
- Bounty Offered: 1.000[<sup>1</sup>](#table2)
- Bounty Collected: 0.753[<sup>2</sup>](#table1)
- Opponent Network: 0.459[<sup>2</sup>](#table1)
- LAN Wins: 1.000[<sup>2</sup>](#table1)

The average of these factors is 0.803<br />
<br />
Next, take the maximum and minimum average across all teams and compute the following:<br />
- 400 + ( ( Roster_Average - Min_Average ) / ( Max_Average - Min_Average ) ) * 1600 = 1954.5
- 400 + ( ( 0.803 - 0.000 ) / ( 0.826 - 0.000 ) ) * 1600 = 1954.5
...
| -: | -: | :- | :- | :- | :- | :- | :- | :- | :- | -: | :- |
|           31 |       40 | 2024-09-06 | 3DMAX         | W   | 1.000      | 0.889        | 0.509 (0.452)    | 0.951 (0.846)    | 1 (1.000) |     1.87 | chopper, donk, magixx, sh1ro, zont1x |
|           30 |       52 | 2024-09-06 | The MongolZ   | W   | 1.000      | 0.889        | 0.864 (0.768)    | 0.695 (0.617)    | 1 (1.000) |     5.50 | chopper, donk, magixx, sh1ro, zont1x |
|           29 |       90 | 2024-09-05 | MIBR          | L   | 1.000      | -            | -                | -                | -         |   -30.56 | chopper, donk, magixx, sh1ro, zont1x |
|           28 |      125 | 2024-09-04 | Wildcard      | W   | 1.000      | 0.889        | -                | 0.608 (0.540)    | 1 (1.000) |     0.36 | chopper, donk, magixx, sh1ro, zont1x |
|           27 |      202 | 2024-09-01 | Eternal Fire  | W   | 1.000      | 0.769        | 0.972 (0.747)    | 0.700 (0.538)    | 1 (1.000) |     7.97 | chopper, donk, magixx, sh1ro, zont1x |
|           26 |      225 | 2024-08-30 | MOUZ          | W   | 1.000      | 0.769        | 1.000 (0.769)    | 0.382 (0.293)    | 1 (1.000) |    12.99 | chopper, donk, magixx, sh1ro, zont1x |
|           25 |      265 | 2024-08-29 | FURIA         | W   | 1.000      | 0.769        | 0.319 (0.245)    | 0.513 (0.394)    | 1 (1.000) |     3.83 | chopper, donk, magixx, sh1ro, zont1x |
|           24 |      346 | 2024-08-28 | Falcons       | W   | 1.000      | 0.769        | 0.297 (0.228)    | 0.477 (0.366)    | 1 (1.000) |     2.86 | chopper, donk, magixx, sh1ro, zont1x |
|           23 |      950 | 2024-08-11 | G2            | L   | 1.000      | -            | -                | -                | -         |   -14.97 | chopper, donk, magixx, sh1ro, zont1x |
|           22 |      973 | 2024-08-10 | The MongolZ   | L   | 1.000      | -            | -                | -                | -         |   -25.12 | chopper, donk, magixx, sh1ro, zont1x |
|           21 |     1217 | 2024-08-03 | Complexity    | W   | 0.959      | -            | -                | -                | 1 (0.959) |     1.86 | chopper, donk, magixx, sh1ro, zont1x |
|           20 |     1384 | 2024-07-30 | HEROIC        | W   | 0.932      | 0.581        | -                | 0.412 (0.223)    | 1 (0.932) |     1.42 | chopper, donk, magixx, sh1ro, zont1x |
